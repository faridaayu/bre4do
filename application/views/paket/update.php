                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                    <?php echo form_open('Paket/Update', array('class' => 'cmxform form-horizontal', ));
                                    echo form_hidden('id', $this->uri->segment(3));?>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Nama Paket</label>
                                        <div class="col-lg-6">
                                            
                                            <input id="nama_paket" value="<?php echo @$listpaket['nama_paket']?>" name="nama_paket" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input id="harga_paket" value="<?php echo @$listpaket['harga_paket']?>" name="harga_paket" type="text" class="form-control">
                                        </div>
                                    </div>
